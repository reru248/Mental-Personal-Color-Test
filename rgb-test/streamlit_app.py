...
div[data-testid="stButton"] > button { width: 140px; height: 55px; font-size: 2rem; font-weight: bold; border-radius: 8px; border: 2px solid #e0e0e0; }
...
# --- 종합 결과 이미지 생성 함수 (겹침 및 잘림 문제 해결 반영) ---
